    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg mx-auto text-gray-700 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-4">User Account</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-4">Service Usage</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-4">Changes</h2>
            <p>
          ...
          <section>
            ...
            <p>
              If you have any questions about these Terms, please contact us via the <a href="/contact" className="text-blue-600 hover:text-blue-800 underline">Contact Us</a> page.
            </p>
          </section>
        </div>
      </div>
