    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950 text-gray-900 dark:text-gray-100 font-sans transition-colors duration-500">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-16 sm:pb-24 max-w-4xl">
        ...
        <div className="prose prose-lg mx-auto text-gray-600 dark:text-gray-400 space-y-6 sm:space-y-8 text-sm sm:text-base leading-relaxed">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">Service Providers</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">Links To Other Sites</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">Children's Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">Compliance with Meta's Policies</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">Changes To This Privacy Policy</h2>
            <p>
          ...
          <section>
            ...
            <p>
              If you have any questions about this Privacy Policy, please contact us via the <a href="/contact" className="text-[#833AB4] dark:text-purple-400 hover:underline">Contact Us</a> page.
            </p>
          </section>
        </div>
      </div>
