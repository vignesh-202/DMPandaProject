                                ...
                                <div className="space-y-3 pt-2 border-t border-border">
                                    ...
                                    <div className="flex flex-wrap items-center gap-3">
                                        <button
                                            ...
                                            className="h-9 px-4 rounded-xl bg-gradient-to-r from-[#405DE6] via-[#833AB4] to-[#FD1D1D] text-white hover:opacity-95 text-xs font-medium shadow-sm transition-all active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
                                        >
