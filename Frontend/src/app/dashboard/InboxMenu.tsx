                                ...
                                {isCreatingItem ? (
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                {status === 'match' && !inboxMenuLoading && (
                                                    <button
                                                        ...
                                                        className="inline-flex items-center justify-center gap-1.5 h-9 px-3.5 rounded-xl text-xs font-medium bg-gradient-to-r from-[#405DE6] via-[#833AB4] to-[#FD1D1D] text-white hover:opacity-95 transition-all active:scale-[0.98] disabled:opacity-50 shadow-sm"
                                                    >
                                    ...
                                    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-border bg-card/40 px-4 py-12 sm:py-16 text-center">
                                        ...
                                        <button
                                            ...
                                            className="inline-flex items-center gap-2 h-10 px-5 rounded-xl bg-gradient-to-r from-[#405DE6] via-[#833AB4] to-[#FD1D1D] text-white hover:opacity-95 text-sm font-medium transition-all shadow-sm active:scale-[0.98]"
                                        >
