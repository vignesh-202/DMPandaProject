...
const TRAFFIC_WINDOW_OPTIONS: Array<{ value: AnalyticsWindowPreset; label: string; note: string }> = [
    { value: '24h', label: '24 hours', note: 'Hourly view' },
    { value: '3d', label: '3 days', note: 'Short trend' },
    { value: '7d', label: '7 days', note: 'Weekly view' },
    { value: '14d', label: '14 days', note: 'Biweekly view' },
    { value: '21d', label: '21 days', note: 'Growth pulse' },
    { value: '30d', label: '30 days', note: 'Monthly view' }
];
