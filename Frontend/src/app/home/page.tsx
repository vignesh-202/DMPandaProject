        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              { icon: faLink, title: 'Google Sheets Linkup', description: 'Send collected email leads into Google Sheets so your email-capture automations stay organized and ready for follow-up.' },
              { icon: faCogs, title: 'Custom Webhook', description: 'Push collected email data to your own webhook so external CRM, sheet, or email systems can process each lead instantly.' },
