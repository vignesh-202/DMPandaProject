        ...
        <ScrollView style={[styles.container, { backgroundColor: bgColor }]}>
            <View style={[styles.card, { backgroundColor: cardBg }]}>
                <View style={styles.iconContainer}>
                    <AtSign color={textColor} size={48} />
                </View>
                <Text style={[styles.title, { color: textColor }]}>Mentions</Text>
                <Text style={[styles.description, { color: mutedColor }]}>
                    Track and respond to mentions of your account across Instagram.
                </Text>
                <View style={[styles.comingSoon, { backgroundColor: isDark ? '#374151' : '#e5e7eb' }]}>
                    <Text style={[styles.comingSoonText, { color: textColor }]}>
                        View and manage mentions
                    </Text>
                </View>
            </View>
        </ScrollView>
